# Microsoft 365: Teams & Groups Collaboration

## What I Did
Practiced team collaboration and group management in Microsoft 365 using a free Developer Tenant. I successfully created a Microsoft Team for IT Support with organized channels, created a Microsoft 365 Group for Finance department, managed team members, and demonstrated file sharing and communication features. This lab demonstrates understanding of modern workplace collaboration tools and how organizations use Teams and Groups for productive teamwork.

## Steps Performed

### 1. Accessed Teams and Groups
...
```
Microsoft Team
├─ Backed by Microsoft 365 Group
├─ Uses SharePoint for files
├─ Includes Exchange mailbox
...
- Type: Private (only invited members)
- Purpose: IT support team collaboration
...
**Channels Created:**
- General (default channel for team announcements)
- Updates (for team updates and status)
- Tickets (for support ticket discussions)

**Channel Structure Explained:**
- Each channel has separate conversation history
- Members can follow specific channels
...
- Posted in General channel
- All team members see the message
- Messages are archived for history
...
- Upload directly to team channel
- Files stored in SharePoint automatically
...
**Group Configuration:**
- Name: Finance Team
- Type: Private (members-only access)
- Email: finance@Archana365Lab.onmicrosoft.com
...
- Site address: archana365lab.sharepoint.com/sites/finance/
- Created automatically with group
- Stores group documents
...
- **Microsoft Teams:** Modern collaboration platform combining chat, meetings, files, and integrations. Organized around projects and teams with channels for focused conversations.

- **Microsoft 365 Groups:** Foundation for Teams and collaboration. Provides email address, shared calendar, and SharePoint site. Every Team has a backing Group automatically.

- **Channels:** Organize conversations within a team. Each channel has separate chat history, files, and pins. Good for different topics or projects within the same team.

- **File Storage:** Team files automatically stored in SharePoint. All team members can access, edit, and collaborate. Version control maintained automatically.

- **Team Members:** Control who can access the team and what they can do. Owners manage team and members. Can add members anytime.

- **SharePoint Integration:** Every Group gets automatic SharePoint site for documents. Site URL generated automatically. Provides document management at scale.

- **Real-Time Communication:** Teams chat enables instant communication. Better than email for quick decisions and discussions. Keeps conversation history for reference.

- **Help Desk Relevance:** Teams and Groups support is critical for modern IT. Help desk handles: "Add me to team," "I can't access team," "Set up team for our department."

- **Scalability:** Teams and Groups scale from small project teams to organization-wide collaboration. Works the same way whether 5 or 500 members.
